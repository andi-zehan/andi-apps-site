...
- `apps/quickmealcheck/privacy.html` — Published Quick Meal Check privacy-policy page with the live code-aligned legal copy.
- `apps/quickmealcheck/support.html` — Quick Meal Check support and FAQ page.
- `apps/quickmealcheck/content/privacy-policy.md` — Editable Quick Meal Check privacy-policy source kept aligned with the app and backend behavior.
